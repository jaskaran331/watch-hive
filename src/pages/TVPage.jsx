...
export default function TVPage({
  ...
  }, [item.id, selectedEp?.episode_number, selectedSeason, playerSource, playing, isAnime, playerAccentColor, playerSubLang]);
  ...
  useEffect(() => {
    ...
    const pollDuration = setInterval(async () => {
      ...
      try {
        const dur = await Promise.reject().catch(
  ...
  useEffect(() => {
    ...
    const inject = () => {
      Promise.reject().catch(INJECT_SKIP_CONTROLS).catch(() => {});
    };
